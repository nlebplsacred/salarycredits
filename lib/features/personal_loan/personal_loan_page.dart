...
class PersonalLoanPage extends StatefulWidget {
  ...
  const PersonalLoanPage({required this.product, required this.dashboardBaseModel, super.key});

  @override
  State<PersonalLoanPage> createState() => _PersonalLoanPageState();
}
...
class _PersonalLoanPageState extends State<PersonalLoanPage> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      setState(() {
        ...
        getLoanEligibility(productList.minLoanAmount, 12); //default loading
      });
    });
  }
              ...
              Container(
                ...
                child: const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("What is SalaryCredits Personal Loan?", style: AppStyle.pageTitle),
                      SizedBox(height: 8),
                      Text(
                          "Embark on your financial journey with SalaryCredits Personal Loan, a versatile offering that allows you to borrow up to 5 times your monthly salary. This tailored loan product provides the flexibility to choose a repayment tenure, ranging from a minimum of 12 months to an extended period of up to 18 months. T&C",
                      ...
                      SizedBox(height: 4),
                      Text("Submit your request for Personal Loan through our user-friendly platform.", style: AppStyle.textLabel),
                      SizedBox(height: 8),
                      ...
                      SizedBox(height: 4),
                      Text("Tailor the repayment period according to your financial preferences, ranging from 12 to 18 months.",
                          style: AppStyle.textLabel),
                      SizedBox(height: 8),
  ...
  Stack loadMainScreen(ActionTagDetails actionTagDetails) {
    ...
    return Stack(
      ...
      children: [
        Visibility(
            visible: true,
            child: user.netPayableSalary! >= 25000
                ? getMainSliderScreen(loanEligibilityResponseModel, actionTagDetails)
                : getMessageBox("Sorry, basic minimum eligibility of salary did not meet hence you can not put request for Personal Loan")),
  ...
  Container getPartialSlider(LoanEligibilityResponseModel model) {
    ...
    return model.getAvailableLoanLimit >= 100000
        ? Container(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Text("18 Months", style: AppStyle.pageTitle2),
                    ],
                  ),
                ),
                Padding(
